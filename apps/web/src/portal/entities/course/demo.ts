import { Course, LessonMaterial, LessonMaterialFormat } from "@/portal/entities/course/types";
...
export function makeCourses(): Course[] {
  const courses: Omit<Course, "progress">[] = [
    {
      id: "c1",
      title: "Backend Engineering вЂ” APIs & Databases",
    ...
    {
      id: "c2",
      title: "Frontend Engineering вЂ” Angular UI",
      teacher: "Emily Davis",
    ...
    {
      id: "c3",
      title: "Biology вЂ” Cells to Systems",
