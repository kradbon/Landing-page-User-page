      ...
      <div class="w-full max-w-md rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <div class="flex items-center justify-between gap-3">
          <div class="flex items-center gap-3">
            <div class="h-11 w-11 overflow-hidden rounded-2xl bg-slate-900 text-white flex items-center justify-center" aria-hidden="true">
              <img src="/login-icon.png" alt="" class="h-full w-full object-cover" />
            </div>
            <div>
